...
- The spatiotemporal distribution of Mesozoic dinosaur diversity
  Autores: Philip D. Mannion.
  DOI: https://doi.org/10.1098/rsbl.2024.0443

- The extinction of the dinosaurs
  Autores: Brusatte, S.L. et al.
  DOI: https://doi.org/10.1111/brv.12128
...
🔎 Resultado:
A biodiversidade dos dinossauros evoluiu ao longo do tempo: começou baixa no Triássico, aumentou no Jurássico e atingiu alta diversidade no Cretáceo.

---

### Prompt 2
"Explique os fatores que podem ter causado a queda na biodiversidade"

🔎 Resultado:
A queda da biodiversidade no final do Cretáceo foi causada principalmente pelo impacto de um asteroide, além de fatores como vulcanismo e mudanças climáticas.

---

### Prompt 3 (melhorado)
"Com base no dataset e nas fontes, explique a evolução da biodiversidade dos dinossauros ao longo dos períodos geológicos"

🔎 Resultado:
A linhagem dos dinossauros não foi totalmente extinta: as aves são seus descendentes diretos e continuam até hoje.

---

### ⚠️ Dificuldades encontradas
- Respostas iniciais muito longas e difíceis de sintetizar
- Necessidade de melhorar os prompts para obter respostas mais objetivas
...
- **Cretáceo:** alta diversidade e especialização, seguida de extinção em massa no final  
...
- Consequências: mudanças climáticas e colapso das cadeias alimentares  
...
- Atualmente, representam um dos grupos mais diversos de animais  
...
- **Fóssil:** vestígio preservado de seres vivos antigos  
- **Período geológico:** divisão do tempo da Terra  
- **Linhagem evolutiva:** sequência de evolução de um grupo de organismos  
